...
def df_to_pant_json(df):
	menu = {"Courses":{"Piping Breads":{},"Riveting Desserts":{},"New Launch":{},"Power Up Main Course":{},"Tank Up On Rice":{},"Top Gear Combos":{},"Speedy Combos":{},"Super Coolants":{},"Blazing Rolls":{},"Full Throttle Starters":{}}}
	for row in df.itertuples():
		if(row.v_n == "veg"):
			v_n = "Veg"
		elif(row.v_n == "nonveg"):
			v_n = "Non Veg"
		if(row.category == "specials"):
			menu["Courses"]["New Launch"][row.name.replace("_"," ").title()] = [v_n,row.price]
		elif(row.category == "subzi"):
			menu["Courses"]["Power Up Main Course"][row.name.replace("_"," ").title()] = [v_n,row.price]
		elif(row.category == "starter"):
			menu["Courses"]["Full Throttle Starters"][row.name.replace("_"," ").title()] = [v_n,row.price]
		elif(row.category == "roll"):
			menu["Courses"]["Blazing Rolls"][row.name.replace("_"," ").title()] = [v_n,row.price]
		elif(row.category == "bread"):
			menu["Courses"]["Piping Breads"][row.name.replace("_"," ").title()] = [v_n,row.price]
		elif(row.category == "rice"):
			menu["Courses"]["Tank Up On Rice"][row.name.replace("_"," ").title()] = [v_n,row.price]
		elif(row.category == "combo"):
			menu["Courses"]["Top Gear Combos"][row.name.replace("_"," ").title()] = [v_n,row.price]
		elif(row.category == "mini_combo"):
			menu["Courses"]["Speedy Combos"][row.name.replace("_"," ").title()] = [v_n,row.price]
		elif(row.category == "dessert"):
			menu["Courses"]["Riveting Desserts"][row.name.replace("_"," ").title()] = [v_n,row.price]
		elif(row.category == "beverage"):
			menu["Courses"]["Super Coolants"][row.name.replace("_"," ").title()] = [v_n,row.price]
	return menu
